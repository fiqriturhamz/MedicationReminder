...
class MedDetailActivity : AppCompatActivity() {
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            lifecycleScope.launch(lifecycleDispatcher) {
                ...
                val rxNumberText = if (medication!!.rxNumber == Medication.UNDEFINED) {
                    ...
                    getString(R.string.prescription_number_label_format, undefinedText)
                }
                else {
                    getString(R.string.prescription_number_label_format, medication!!.rxNumber)
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        previousDosesList.onItemLongClickListener = AdapterView.OnItemLongClickListener { _, _, i, _ ->
        ...
        previousDosesList.setOnItemClickListener { _, _, position, _ ->
